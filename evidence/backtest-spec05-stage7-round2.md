...
| https://flagcrack.com/ | B-/73.57 | B-/73.70 | B-/73.70 | +0.00 | same | — | high cov=100% blk=0% |  |
...
| https://brandremaster.com/ | C-/59.34 | C-/59.08 | C-/59.08 | +0.00 | same | unreachable_page:-3, incomplete_crawl:+1 | low cov=39% blk=0% partial |  |
...
| https://leetcode.com/ | C/60 | A/90.78 | A/90.78 | +0.00 | same | — | medium cov=78% blk=0% partial |  |
| https://www.figma.com/resource-library/what-is-wireframing/ | C+/69.86 | B-/70.43 | B-/70.43 | +0.00 | same | unreachable_page:-47, incomplete_crawl:+1 | low cov=28% blk=0% partial |  |
...
| https://mohammadalinijhoom.com | C/62.87 | C/62.81 | C/62.81 | +0.00 | same | incomplete_crawl:+1 | low cov=30% blk=0% partial |  |
...
| https://rewardguru.in/ | D-/42.53 | D-/42.54 | D-/42.55 | +0.01 | same | orphan:-1 | high cov=99% blk=0% |  |
...
**0** excluded (logged above, not dropped). **15** partial (budget/cap-truncated crawl; the v1↔v2 diff is still valid).